...
;  assertions = 4
;  timeout = 5
;  time    = {'../SMT_Solvers/QF_S/cvc4/run.sh': 0.03913068771362305, '../SMT_Solvers/QF_S/z3str3/run.sh': 0.12285232543945312}
...
(assert (str.in.re (str.replace (str.++ var1 "|la98QT#c6") (str.++ var1 "|la98QT#c6") (str.++ var1 "|la98QT#c6")) (re.+ (re.range (str.substr (str.replace var1 var1 var1) (str.len var0) (str.indexof var2 var0 var4)) (str.substr (str.replace var1 var1 var1) (str.len var0) (str.indexof var2 var0 var4))))))
(check-sat)