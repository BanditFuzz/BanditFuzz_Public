...
;  assertions = 4
;  timeout = 5
;  time    = {'../SMT_Solvers/QF_S/cvc4/run.sh': 10.0, '../SMT_Solvers/QF_S/z3str3/run.sh': 3.4127211570739746}
...
(assert (< (str.len (str.replace var2 var1 var2)) (str.indexof (str.++ var1 var1) (str.replace var1 var2 var0) (str.indexof var0 var1 var3))))
