...
;  assertions = 4
;  timeout = 5
;  time    = {'../SMT_Solvers/QF_S/cvc4/run.sh': 0.042012691497802734, '../SMT_Solvers/QF_S/z3str3/run.sh': 0.11722016334533691}
...
(assert (str.in.re (str.replace (str.replace var1 "|la98QT#c6" var1) (str.replace var1 "|la98QT#c6" var1) (str.replace var1 "|la98QT#c6" var1)) (re.range (str.substr (str.at var0 var4) (str.indexof var0 var2 var3) (str.len var1)) (str.replace var0 var2 var0))))
(check-sat)