...
;  assertions = 4
;  timeout = 5
;  time    = {'../SMT_Solvers/QF_S/cvc4/run.sh': 10.0, '../SMT_Solvers/QF_S/z3str3/run.sh': 0.2438826560974121}
...
(assert (< (str.len (str.replace var2 var1 var2)) (str.indexof (str.substr var1 var4 3) (str.at var1 (str.indexof (str.substr var0 var5 var5) (str.replace var1 var2 var1) (str.len var0))) (str.indexof var0 var1 var3))))
